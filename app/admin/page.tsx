...
export default async function AdminDashboardPage() {
  ...
  let me: MeResponse;
  try {
    me = (await laravelServerFetch("/backend/auth/me")) as MeResponse;
  } catch {
    redirect("/auth/login");
  }
  ...
  const packagesInventory = (await laravelServerFetch(
    "/backend/admin/dashboard/packages-inventory"
